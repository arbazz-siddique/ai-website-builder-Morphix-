...
import { Code, Code2, Download, Monitor, SquareArrowUpRight, TabletSmartphone } from 'lucide-react'
    ...
    <div className='p-2 shadow rounded-xl w-full flex items-center justify-between'>
        <div className='flex gap-2'>
            ...
            className={`${selectedScreenSize =='desktop' ? ' border border-primary': null}`}
             onClick={()=>setSelectedScreenSize('desktop')}> <Monitor/> </Button>
